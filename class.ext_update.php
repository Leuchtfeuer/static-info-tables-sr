<?php
namespace SJBR\StaticInfoTablesSr;
...
class ext_update
{
	...
	public function main()
	{
		...
		$databaseUpdateUtility->doUpdate('static_info_tables_sr');

		$content.= '<p>' . LocalizationUtility::translate('updateLanguageLabels', 'StaticInfoTables') . ' static_info_tables_sr.</p>';
		return $content;
	}
